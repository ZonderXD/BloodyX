...
async def on_message(msg):
    if msg.author.bot or msg.author.id == 668325441224048641 or msg.author.id == 342317507991961602 or msg.author.id == 4919286595994255371 or msg.author.id == 662346548025491476:
        pass
    else:
