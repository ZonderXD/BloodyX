...
async def blacklist(ctx):
  ...
  emb.add_field(name=f'**🎩 Как снять чс:**', value="**Напишите в лс <@716724192065749075>: ```Здравствуйте, я хочу снять чёрный список. Буду ждать вашего ответа.```\n И ждите когда создатель Вам ответит.**", inline=False)
