...
async def help(ctx):
	...
	emb.add_field(name='🎶 Роблокс музыка:', value='`.music`', inline = False)
...
async def music(ctx, *, arg: int = None):
  if arg == None:
    ...
    await ctx.send(embed = discord.Embed(description = f'`7.` Lida х Tenderlybae "Грустный реп" - `4518984639`\n `8.` "Реальный Flesh" - `3766039768`\n `9.` VTORNIK "Ракета" - `3666410231`\n `10.` Lizer "Убьют за нас" - `3134163814`\n `11.` 3-ий Январь "Хубба Бубба" - `4502015210`\n `12.` "Надо Поле Притоптать" - `1170717899`', color=0x6fdb9e))
