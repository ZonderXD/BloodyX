...
async def music(ctx):
    ...
    embed1 = discord.Embed(title ='⚠ Патент:', description='**`❗` Кто сп#здит коды, тому п#зда! `❗`**', color = 0x6fdb9e)
